...
M.load = function(opts)
  ...
  hl('Constant', { fg = c.cyan, bold = config.glow }, { styles = config.styles.constants, glow = config.glow }) -- any constant
  hl('String', { fg = c.purple }) -- a string constant: "this is a string"
  hl('Character', { link = 'String' }) -- a character constant: 'c', '\n'
  hl('Number', { fg = c.purple, bold = config.glow }, { styles = config.styles.numbers, glow = config.glow }) -- a number constant: 234, 0xff
  ...
  hl('Keyword', { fg = c.pink, bold = config.glow }, { styles = config.styles.keywords, glow = config.glow }) -- any other keyword
  ...
  hl('Type', { fg = c.purple }, { styles = config.styles.types }) -- int, long, char, etc.
