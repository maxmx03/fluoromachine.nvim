...
M.load = function(opts)
  ...
  hl('Constant', { fg = c.purple, bold = config.glow }, { styles = config.styles.constants, glow = config.glow }) -- any constant
  ...
  hl('Delimiter', { fg = c.pink }) -- character that needs attention
