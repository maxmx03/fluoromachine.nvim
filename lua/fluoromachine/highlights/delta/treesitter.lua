...
M.load = function(opts)
  ...
  hl('@constant.html', { fg = c.pink, bold = config.glow }, { glow = config.glow })
  ...
  hl('@tag', { fg = c.pink, bold = config.glow }, { glow = config.glow })
  hl('@tag.attribute', { fg = c.green, bold = config.glow }, { glow = config.glow })
  hl('@tag.delimiter', { fg = c.fg }, { glow = config.glow })
  hl('@property', { fg = c.fg })
