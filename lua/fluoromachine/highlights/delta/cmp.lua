...
M.load = function(opts)
  ...
  hl('CmpItemAbbrMatch', { fg = c.red }, { glow = config.glow }) -- Highlight group for matched characters of each completion field.
  hl('CmpItemAbbrMatchFuzzy', { fg = c.red }, { glow = config.glow }) -- Highlight group for fuzzy-matched characters of each completion field.
