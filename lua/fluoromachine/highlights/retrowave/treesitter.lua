...
M.load = function(opts)
  ...
  hl('@constant.html', { fg = c.green, bold = config.glow }, { glow = config.glow })
  ...
  hl('@tag', { fg = c.green, bold = config.glow }, { glow = config.glow })
  hl('@tag.attribute', { fg = c.cyan, bold = config.glow }, { glow = config.glow })
  hl('@tag.delimiter', { fg = c.cyan }, { glow = config.glow })
