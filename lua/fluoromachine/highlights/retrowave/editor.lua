...
M.load = function(opts)
  ...
  if config.glow then
    hl('LineNr', { fg = darken(c.green, 50), bg = c.bg }, { transparent = config.transparent })
    hl('CursorLineNr', { fg = c.green, bg = c.bg, bold = true }, { transparent = config.transparent })
  end
  ...
  hl('Directory', { fg = c.cyan })                                                                   -- directory names
  ...
  hl('Whitespace', { fg = c.comment })                                                                 -- "nbsp", "space", "tab", "multispace", "lead" and "trail" in 'listchars'.
