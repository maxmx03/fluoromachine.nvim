...
theme.set_highlights = function(c)
  ...
  hl(0, 'String', { fg = c.purple, bg = 'NONE' })
  ...
  hl(0, 'Identifier', { fg = c.yellow, bg = 'NONE', italic = true })
  ...
  hl(0, '@constructor.tsx', { fg = c.purple, bg = 'NONE' })
  hl(0, '@constructor.javascript', { fg = c.purple, bg = 'NONE' })
  hl(0, '@parameter', { fg = c.cyan, bg = 'NONE', italic = true })
  hl(0, '@boolean', { link = 'Boolean' })
  hl(0, '@number', { link = 'Number' })
  hl(0, '@float', { link = 'Float' })
  hl(0, '@label.json', { fg = c.pink, bg = 'NONE' })
  hl(0, '@label.ruby', { link = '@variable.builtin' })
  hl(0, '@exception', { link = 'Exception' })
  hl(0, '@type', { link = 'Type' })
  hl(0, '@type.dart', { link = '@type' })
  hl(0, '@type.builtin', { fg = c.purple, bg = 'NONE', italic = true })
  hl(0, '@type.builtin.cpp', { fg = c.purple, bg = 'NONE', italic = true })
  ...
  hl(0, '@namespace', { fg = c.purple, bg = 'NONE' })
  ...
  hl(0, 'NvimTreeEmptyFolderName', { fg = c.yellow, bg = 'NONE', italic = true })
  ...
  -- MiniCompletion
  hl(0, 'MiniCompletionActiveParameter', { link = '@parameter' })

  -- MiniJump
  hl(0, 'MiniJump2dSpot', { fg = c.pink, bg = 'NONE' })
  hl(0, 'MiniJump2dSpotUnique', { fg = c.purple, bg = 'NONE' })

  -- MiniIndent
  hl(0, 'MiniIndentscopeSymbol', { fg = c.pink, bg = 'NONE' })
