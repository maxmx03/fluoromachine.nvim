...
theme.set_highlights = function(c)
  ...
  hl(0, 'CursorLineNr', { fg = c.green, bg = c.bg })
  ...
  hl(0, 'Directory', { fg = c.green, bg = 'NONE' })
  ...
  hl(0, 'IncSearch', { fg = c.green, bg = 'NONE' })
  hl(0, 'Substitute', { link = 'IncSearch' })
  hl(0, 'MoreMsg', { fg = c.green, bg = 'NONE', bold = true })
  hl(0, 'Question', { fg = c.green, bg = 'NONE', bold = true })
  ...
  hl(0, '@string.regex', { fg = c.pink, bg = 'NONE' })
  ...
  hl(0, '@label.json', { fg = c.green, bg = 'NONE' })
  ...
  hl(0, '@variable', { fg = c.fg, bg = 'NONE' })
  hl(0, '@variable.builtin', { fg = c.red, bg = 'NONE', italic = true })
