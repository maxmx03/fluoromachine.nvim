...
local function darken(hex, percentage)
  ...
  return rgb_to_hex(result.red, result.green, result.blue)
end

local function lighten(color, percentage)
...
local function blend(fg, bg, alpha)
  local red_bg, green_bg, blue_bg = hex_to_rgb(bg)
  local red_fg, green_fg, blue_fg = hex_to_rgb(fg)
  return rgb_to_hex(
